    ...
    <div className="space-y-3">
      {isEditing.farmDetails ? (
        <>
          {renderEditableField(
            "totalArea",
            farmer.farmDetails.totalArea,
            (value) =>
              setFarmer({
                ...farmer,
                farmDetails: { ...farmer.farmDetails, totalArea: value },
              })
          )}
          {renderEditableField(
            "irrigatedArea",
            farmer.farmDetails.irrigatedArea,
            (value) =>
              setFarmer({
                ...farmer,
                farmDetails: { ...farmer.farmDetails, irrigatedArea: value },
              })
          )}
          {renderEditableField(
            "primaryCrops",
            farmer.farmDetails.primaryCrops.join(", "),
            (value) =>
              setFarmer({
                ...farmer,
                farmDetails: {
                  ...farmer.farmDetails,
                  primaryCrops: value.split(", "),
                },
              })
          )}
          <button
        ...
        <>
          ...
          <div className="flex items-center gap-3">
            ...
            <span>
              Primary Crops: {farmer.farmDetails.primaryCrops.join(", ")}
            </span>
          </div>
        </>
      )}
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <button
                  onClick={() =>
                    setIsEditing({
                      ...isEditing,
                      farmDetails: !isEditing.farmDetails,
                    })
                  }
                  className="text-green-600 hover:text-green-700"
                >
