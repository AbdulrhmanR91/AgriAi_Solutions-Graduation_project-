    ...
    <div className="space-y-3">
      {isEditing.SpecializationDetails ? (
        <>
          {renderEditableField(
            "Specialization",
            engineer.SpecializationDetails.Specialization,
            (value) =>
              setEngineer({
                ...engineer,
                SpecializationDetails: {
                  ...engineer.SpecializationDetails,
          ...
          {renderEditableField(
            "ServicesTypes",
            engineer.SpecializationDetails.ServicesTypes,
            (value) =>
              setEngineer({
                ...engineer,
                SpecializationDetails: {
        ...
        <>
          <div className="flex items-center gap-3">
            ...
            <span>
              Specialization: {engineer.SpecializationDetails.Specialization}
            </span>
          </div>

          <div className="flex items-center gap-3">
            <span>
              Services Types: {engineer.SpecializationDetails.ServicesTypes}
            </span>
          </div>
        </>
      )}
