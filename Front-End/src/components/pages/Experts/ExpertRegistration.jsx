          ...
          <form onSubmit={handleSubmit}>
            {currentStep === 1 && (
              <div className="space-y-6">
                ...
                <div className="relative">
                  <select
                    className="absolute left-3 top-1/2 transform -translate-y-1/2 text-green-600 bg-transparent border-none focus:outline-none"
                    value={selectedCountryCode}
                    onChange={(e) => setSelectedCountryCode(e.target.value)}
                    style={{ width: "120px" }} // Adjust the width to fit the country codes
                  >
                  ...
                  <input
                    ...
                    className={`w-full pl-[130px] pr-4 py-3 border-2 rounded-xl focus:outline-none focus:border-green-500 ${
