...
const CompanyRegistration = () => {
    ...
    const validateStep = (step) => {
        ...
        if (step === 2) {
            ...
            if (!formData.taxRegistrationNumber) newErrors.taxRegistrationNumber = "Tax registration number is required.";
        }
        if (step === 3) {
            if (!formData.tradeLicenseFile) newErrors.tradeLicenseFile = "Trade license file is required.";
            if (!formData.taxRegistrationFile) newErrors.taxRegistrationFile = "Tax registration file is required.";
                            ...
                            <div className="space-y-6">
                                <div className="relative">
                                    <input
                                        ...
                                        className={`w-full pl-4 pr-4 py-3 border-2 rounded-xl focus:outline-none focus:border-green-500 ${errors.companyName ? 'border-red-500' : 'border-gray-300'}`}
                            ...
                            <div className="space-y-6">
                                <div className="relative">
                                    <input
                                        ...
                                        className={`w-full pl-4 pr-4 py-3 border-2 rounded-xl focus:outline-none focus:border-green-500 ${errors.businessAddress ? 'border-red-500' : 'border-gray-300'}`}
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className={`w-full pl-4 pr-4 py-3 border-2 rounded-xl focus:outline-none focus:border-green-500 ${errors.governorate ? 'border-red-500' : ' border-gray-300'}`}
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className={`w-full pl-4 pr-4 py-3 border-2 rounded-xl focus:outline-none focus:border-green-500 ${errors.tradeLicenseNumber ? 'border-red-500' : 'border-gray-300'}`}
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className={`w-full pl-4 pr-4 py-3 border-2 rounded-xl focus:outline-none focus:border-green-500 ${errors.taxRegistrationNumber ? 'border-red-500' : 'border-gray-300'}`}
