    ...
    const notifications = [
        {
            ...
            message: 'Potential disease detected in your wheat crops. View AI analysis results.',
            icon: AlertTriangle,
            time: 'Now',
        ...
        },
        {
            ...
            message: 'Your fertilizer order #123 has been shipped and will arrive in 2 days.',
            icon: Tractor,
            time: 'Now',
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="bg-white border-t border-gray-200 p-4 fixed bottom-0 left-0 right-0">
                <div className="flex justify-around">
                    ...
                    <button className="text-gray-500 hover:text-green-500">Notifications</button>
                    <button className="text-gray-500 hover:text-green-500">Profile</button>
                </div>
            </div>
        </div>
    );
