...
const ConsultationsPage = () => {
  ...
  const handleComplete = (id) => {
    setConsultations(consultations.map(consultation => 
      consultation.id === id ? {...consultation, status: 'completed'} : consultation
    ));
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      <header className="sticky top-0 bg-white shadow-sm z-10 p-4">
        <h1 className="text-xl font-bold text-green-600">Consultations Management</h1>
      </header>
        ...
        <div className="flex gap-2 mb-6 overflow-x-auto">
          <button
            ...
            className={`px-4 py-2 rounded-full ${
              status === 'all' ? 'bg-green-500 text-white' : 'bg-white border border-gray-200'
            }`}
          >
            All
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-full ${
              status === 'pending' ? 'bg-green-500 text-white' : 'bg-white border border-gray-200'
            }`}
          >
            Pending
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-full ${
              status === 'completed' ? 'bg-green-500 text-white' : 'bg-white border border-gray-200'
            }`}
          >
            Completed
          </button>
              ...
              <CardContent className="p-4">
                ...
                <div className="space-y-3 text-gray-600">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <a href={`tel:${consultation.phone}`} className="text-green-600">
                      {consultation.phone}
                    </a>
                  </div>
