...
const CompanyProfile = () => {
    const [profileImage, setProfileImage] = useState(companyimg); // الصورة الحالية
    ...
    const [company, setCompany] = useState({
        ...
        contact: {
            email: "DeltaAgriculturalCo@gmail.com",
            phone: "+2010299",
                ...
                <div className="max-w-3xl mx-auto">
                    <div className="text-center mb-8">
                        <div className="relative">
                            ...
                            />
                            <label className="absolute bottom-0 right-1/2 translate-x-12 translate-y-2 p-2 bg-green-600 rounded-full text-white hover:bg-green-700 cursor-pointer">
                                <Edit2 className="w-4 h-4" />
                                <input
                                    type="file"
                                    accept="image/*"
