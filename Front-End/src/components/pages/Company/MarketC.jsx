...
import { Heart, Share2, Plus, ShoppingCart, Minus } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Link to="/company/profile" className="flex items-center space-x-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link to="/company/my-products" className="p-2 text-gray-600 hover:text-gray-900">
  My Products
</Link>
              ...
              <Link to="/company/notifications" className="relative">
